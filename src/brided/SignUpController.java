...
public class SignUpController implements Initializable {
    ...
    private void Daftar(ActionEvent event) throws IOException {
        if(nama.getText().equals("")||tanggal.getValue().equals("")||notelp.getText().equals("")||alamat.getText().equals("")||
                username.getText().equals("")||password.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Lengkapi data yang tertera");
        }
        else{
        try {
            String sql = "INSERT INTO user VALUES('"+nama.getText()+"', '"+tanggal.getValue()+"',  '"+notelp.getText()+"',"

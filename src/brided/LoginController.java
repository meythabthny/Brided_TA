...
public class LoginController implements Initializable {
    ...
    private void Login(ActionEvent event) throws IOException {
        ...
        try {
            sql = "SELECT * FROM user WHERE Username='"+usernameID.getText()+"' AND Password='"+passwordID.getText()+"'";
            rs = stat.executeQuery(sql);
            if(rs.next()){
                if(usernameID.getText().equals(rs.getString("Username")) && passwordID.getText().equals(rs.getString("Password"))){
